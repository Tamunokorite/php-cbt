            ...
            <?php foreach ($data as $key => $val) :?>
                <div class="card">
                    ...
                    <div class="card-footer">
                        <a href="testoptions.php?id=<?= $val->id ?>" class="btn btn-outline-dark">Test Options</a>
                        <span class="float-right">
                          <a href="addquestions.php?id=<?= $val->id ?>" class="btn btn-outline-dark btn-sm">Add Questions</a>
                          <a href="viewquestions.php?id=<?= $val->id ?>" class="btn btn-outline-dark btn-sm">View Questions</a>
                        </span>
                    </div>
                </div>
            <?php endforeach; ?>
            <div class="text-center">
            <a href="addsubject.php" class="btn btn-dark">Add Subject</a> <br><br>
            </div>
          </div>
          <!-- /.col-md-6 -->
        </div>
